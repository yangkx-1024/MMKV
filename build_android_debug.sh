...
cp target/aarch64-linux-android/debug/libmmkv.so android/library/src/main/jniLibs/arm64-v8a/libmmkv.so

echo "Building armv7-linux-androideabi......"
cargo build --target armv7-linux-androideabi
cp target/armv7-linux-androideabi/debug/libmmkv.so android/library/src/main/jniLibs/armeabi-v7a/libmmkv.so

echo "Building x86_64-linux-android......"
cargo build --target x86_64-linux-android
cp target/x86_64-linux-android/debug/libmmkv.so android/library/src/main/jniLibs/x86_64/libmmkv.so

echo "Building with feature encryption...."
echo "Building aarch64-linux-android......"
cargo build --features encryption --target aarch64-linux-android
cp target/aarch64-linux-android/debug/libmmkv.so android/library-encrypt/src/main/jniLibs/arm64-v8a/libmmkv.so

echo "Building armv7-linux-androideabi......"
cargo build --features encryption --target armv7-linux-androideabi
cp target/armv7-linux-androideabi/debug/libmmkv.so android/library-encrypt/src/main/jniLibs/armeabi-v7a/libmmkv.so

echo "Building x86_64-linux-android......"
cargo build --features encryption --target x86_64-linux-android
cp target/x86_64-linux-android/debug/libmmkv.so android/library-encrypt/src/main/jniLibs/x86_64/libmmkv.so